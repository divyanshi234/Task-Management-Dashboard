...
function Layout({onLogout, user}) {
  ...
  const StatCard = ({title, value, icon}) =>(
     ...
     duration-300 hover:border-purple-100 group">
      <div className="flex items-center gap-2">
          <div className="p-1.5 rounded-lg bg-gradient-to-br from-fuchsia-500/10 group-hover:from-fuchsia-500/20
  ...
  if(error) return (
    <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
       <div className="bg-red-50  text-red-50 p-4 rounded-xl border border-red-100 max-w-md">
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <StatCard
                  ...
                  icon={
                    <Circle className="w-4 h-4 sm:h-5 text-purple-500" />
                  }
                />
                <StatCard
                  title="Completed"
                  ...
                  icon={
                    <Circle className="w-4 h-4 sm:h-5 text-green-500" />
                  }
                />
                <StatCard
                  title="Pending"
                  ...
                  icon={
                    <Circle className="w-4 h-4 sm:h-5 text-fuchsia-500" />
                  }
                />
                <StatCard
                  title="Completion Rate"
                  value={`${stats.completionPercentage}%`}
                  icon={<Zap className="w-4 h-4 sm:h-5 text-purple-500" />}
                />
              </div>
              <hr className="my-3 sm:my-4 text-purple-500" />
