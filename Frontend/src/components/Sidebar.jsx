                    ...
                    <div className="flex items-center gap-2">
                        <div className={TIP_CARD.iconWrapper}>
                         ...
                         <div>
                               ...
                               <p className={TIP_CARD.text}>Use keybord shortcuts to boost productivity!</p>
                               <a href="https://in.pinterest.com/" target='_blank' className="block mt-2 text-sm text-purple-500 hover:underline">
        ...
        <div className=" fixed inset-0 z-40">
          <div className={SIDEBAR_CLASSES.mobileDrawerBackdrop} onClick={() => setMobileOpen(false)}/>
            ...
            <div className={SIDEBAR_CLASSES.mobileDrawer} onClick={(e) => e.stopPropagation()}>
              <div className=" flex justify-between items-center mb-4 border-b pd-2"> 
